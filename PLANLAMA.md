...
## Jira’da kullanım ipuçları

- Her **Epic** için tek bir Jira Epic; altındaki **Story**’ler için bileşen (Component) veya etiket: `mvp`, `cv`, `interview-engine`, `voice`, `video`, `feedback`.
- **Task**’ları 1–3 günlük iş parçalarına böl; “AI entegrasyonu” gibi büyük işleri alt task’lara ayır.
- **Definition of Done:** PRD’deki ilgili MVP maddesi için demo + kabul kriteri karşılandı + temel test.

---

*Son güncelleme: PRD `upschool301prddocument.md` ile hizalı planlama taslağıdır; sprint planlamasında tarih ve kapasiteye göre yeniden sıralanmalıdır.*
